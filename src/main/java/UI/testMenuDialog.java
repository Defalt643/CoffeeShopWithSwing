 ...
 * @author Xenon
 */
public class testMenuDialog extends javax.swing.JDialog {

    /**
     * Creates new form testMenuDialog
     */
    ...
    private void initComponents() {
        ...
        testPanel = new javax.swing.JScrollPane();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testMenuDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                testMenuDialog dialog = new testMenuDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JScrollPane testPanel;
